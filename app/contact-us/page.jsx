      ...
      <div className="div">
          ...
          <div className="frame-10">
            ...
            <div className="frame-19">
              ...
              <div className="overlap-2">
                ...
                <p className="text-wrapper-10">Addis Ababa, Bole Sub City, Woreda 01, Kebele 03, House No. 15</p>
              </div>
            </div>
          </div>
        ...
        <Link href="/">
          ...
          <div className="group-2">
            <div className="text-wrapper-12"><Link href="/about-us">About Us</Link></div>
            <div className="text-wrapper-13"><Link href="/contact-us">Contact Us</Link></div>
            <div className="text-wrapper-14"><Link href="/about-us#services">Services</Link></div>
            <Link href="/donate">
